...
{
	cout<<(solver[0][1]*solver[1][2]-solver[0][2]*solver[1][1])<<" ";
	cout<<(solver[0][2]*solver[1][0]-solver[1][2]*solver[0][0])<<" ";
	cout<<(solver[0][0]*solver[1][1]-solver[0][1]*solver[1][0])<<" ]";
	return 0;
}
...
int main()
{
	...
	float sum=0, mid;
	float mat[3][3],a[3],eigena[3],mat2[3][3];
	float *temp;
	int i,j,chen;
